...
module MBlockMatrixD
    ...
    type, public :: DBlockMatrix
        private
        integer :: nblocks = 0, size = 0
        type(DExtRange) :: det
        type(DUpdatableMatrix), allocatable :: block(:)
    ...
    !! concrete update type by setting a pointer of type(DBlockUpdateBase)
    !! and then use get_det() and accept_update().
    type, abstract, public :: DBlockUpdateBase
        private
        type(DBlockMatrix), pointer :: target
        type(DExtRange) :: det
        logical :: allowed
    ...
    abstract interface
        subroutine base_accept_update(self)
            import :: DBlockUpdateBase
            class(DBlockUpdateBase), intent(inout) :: self
        end
    end interface
    ...
    !! propose this update.
    type, extends(DBlockUpdateBase), public :: DBlockReplace
        private
        type(DMatrixReplace), allocatable :: block(:)
        integer :: size
        integer, allocatable :: offset(:)
        integer, allocatable :: lookup(:)
    contains
    ...
    type, extends(DBlockUpdateBase), public :: DBlockGrow
        private
        type(DMatrixGrow), allocatable :: block(:)
        integer :: size
        integer, allocatable :: offset(:)
        integer, allocatable :: lookup(:)
    contains
    ...
    type, extends(DBlockUpdateBase), public :: DBlockShrink
        private
        type(DMatrixShrink), allocatable :: block(:)
        integer :: size, rank
        integer, allocatable :: offset(:)
        integer, allocatable :: lookup(:)
    contains
    ...
    !! update.
    type, extends(DBlockUpdateBase), public :: DBlockReplaceRows
        private
        type(DReplaceRows), allocatable :: block(:)
        integer :: size, rank
    contains
        private
    ...
    !! update.
    type, extends(DBlockUpdateBase), public :: DBlockReplaceCols
        private
        type(DReplaceCols), allocatable :: block(:)
        integer :: size, rank
    contains
        private
    ...
    !! update.
    type, extends(DBlockUpdateBase), public :: DBlockPermute
        private
        type(DMatrixPermute), allocatable :: block(:)
        integer :: size
    contains
        private
...
contains
    ...
    pure logical function p_isinit(self)
        type(DBlockMatrix), intent(in) :: self

        p_isinit = allocated(self%block)
    end

    subroutine p_init(self, nblocks)
        type(DBlockMatrix), intent(inout) :: self
    ...
    pure function p_base_det(self) result(r)
        class(DBlockUpdateBase), intent(in) :: self
        type(DExtRange) :: r
    ...
    pure logical function p_repl_isinit(self)
        type(DBlockReplace), intent(in) :: self

        p_repl_isinit = allocated(self%block)
    end

    subroutine p_repl_init(self, nblocks)
        type(DBlockReplace), intent(inout) :: self
        integer, intent(in) :: nblocks
    ...
    subroutine p_repl_propose(self, t, iblock, jblock, a)
        type(DBlockReplace), intent(inout) :: self
        type(DBlockMatrix), intent(inout), target :: t
    ...
    subroutine p_repl_accept(self)
        class(DBlockReplace), intent(inout) :: self
        integer :: b
    ...
    pure function p_grow_isinit(self) result(test)
        type(DBlockGrow), intent(in) :: self
        logical :: test
    ...
    subroutine p_grow_init(self, nblocks)
        type(DBlockGrow), intent(inout) :: self
        integer, intent(in) :: nblocks
    ...
    subroutine p_grow_accept(self)
        class(DBlockGrow), intent(inout) :: self
        integer :: b
    ...
    pure function p_shrink_isinit(self) result(test)
        type(DBlockShrink), intent(in) :: self
        logical :: test
    ...
    subroutine p_shrink_init(self, nblocks)
        type(DBlockShrink), intent(inout) :: self
        integer, intent(in) :: nblocks
    ...
    subroutine p_shrink_accept(self)
        class(DBlockShrink), intent(inout) :: self
        integer :: b
    ...
    pure function p_rows_isinit(self) result(test)
        type(DBlockReplaceRows), intent(in) :: self
        logical :: test
    ...
    subroutine p_rows_init(self, nblocks)
        type(DBlockReplaceRows), intent(inout) :: self
        integer, intent(in) :: nblocks
    ...
    subroutine p_rows_propose(self, t, ifrom, ito, val)
        ...
        real(c_double) :: val_sort(size(val,1), size(val,2))
    ...
    subroutine p_rows_accept(self)
        class(DBlockReplaceRows), intent(inout) :: self
        integer :: b
    ...
    pure function p_cols_isinit(self) result(test)
        type(DBlockReplaceCols), intent(in) :: self
        logical :: test
    ...
    subroutine p_cols_init(self, nblocks)
        type(DBlockReplaceCols), intent(inout) :: self
        integer, intent(in) :: nblocks
    ...
    subroutine p_cols_accept(self)
        class(DBlockReplaceCols), intent(inout) :: self
        integer :: b
    ...
    pure function p_permute_isinit(self) result(test)
        type(DBlockPermute), intent(in) :: self
        logical :: test
    ...
    subroutine p_permute_init(self, nblocks)
        type(DBlockPermute), intent(inout) :: self
        integer, intent(in) :: nblocks
    ...
    subroutine p_permute_accept(self)
        class(DBlockPermute), intent(inout) :: self
        integer :: b
