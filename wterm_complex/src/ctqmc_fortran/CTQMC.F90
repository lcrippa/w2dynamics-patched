...
implicit none
   ...
   real(c_double)                :: beta
   real(c_double)                :: PercentageGlobalMove, PercentageTauShiftMove
   real(c_double)                :: PercentageOuterMove
   real(c_double)                :: Percentage4OperatorMove
   ...
   real(c_double)                :: PercentageWormInsert,PercentageWormReplace
