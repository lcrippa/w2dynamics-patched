...
module MImpurityD
    ...
    type, public :: DImpurity
        private
        real(c_double) :: beta = -1
        type(DOperEigen) :: hloc
        type(DTPsis) :: psis

        type(DExtRange) :: weight
        integer :: size = 0
    ...
    type, abstract, public :: DImpurityUpdateBase
        private
        type(DImpurity), pointer :: target
        type(DExtRange) :: weight
    ...
    abstract interface
        subroutine base_accept_update(self)
            import :: DImpurityUpdateBase
            class(DImpurityUpdateBase), intent(inout) :: self
        end
    end interface

    type, extends(DImpurityUpdateBase), public :: DImpurityReplace
        private
        integer :: size
        type(impurity_pos), allocatable :: pos(:)
        type(DTKet) :: ket_work
    ...
    type, abstract, extends(DImpurityUpdateBase) :: naive_update
        private
        type(DImpurityReplace) :: naive
    contains
        private
        procedure :: accept_update => p_naive_accept
    end type

    type, extends(DImpurityUpdateBase), public :: DImpurityGrow
        private
    ...
    type, extends(DImpurityUpdateBase), public :: DImpurityShrink
        private
        integer :: new_size, rank
    ...
    type, extends(naive_update), public :: DImpurityShift
        private
        integer :: new_first
        integer, allocatable :: perm(:)
    ...
    type, extends(naive_update), public :: DImpurityUpdate
        private
        integer :: rank
    ...
    real(c_double), parameter :: ZERO = 0, ONE = 1
...
contains
    ...
    subroutine p_init_impurity(self, beta, hloc, psis, outer_sst)
        type(DImpurity), intent(out) :: self
    ...
    subroutine set_to_empty(self, outer_sst)
        type(DImpurity), intent(inout) :: self
        integer, intent(in) :: outer_sst
    ...
    subroutine p_set_impurity(self, ops, outer_sst)
        type(DImpurity), intent(inout), target :: self
        type(TLocalOper), intent(in) :: ops(:)
        integer, intent(in) :: outer_sst
        type(DImpurityReplace) :: move
    ...
    function p_allowed_outer_states(self) result(r)
        type(DImpurity), intent(in), target :: self
        integer, pointer :: r(:)
    ...
    function get_psi_for_localoper(psis, op) result(psi)
        type(DTPsis), intent(in), target :: psis
        type(TLocalOper), intent(in) :: op
        type(DTOperator), pointer :: psi
    ...
    subroutine p_compute_density_matrix(self, sgn, out_op)
        type(DImpurity), intent(in) :: self
        real(c_double), intent(in) :: sgn
        type(DTOperator), intent(inout) :: out_op
    ...
    subroutine init_update_base(self, t)
        class(DImpurityUpdateBase), intent(out) :: self
        type(DImpurity), intent(inout), target :: t
    ...
    pure logical function p_is_update_allowed(self) result(test)
        class(DImpurityUpdateBase), intent(in) :: self
    ...
    subroutine p_init_replace_impurity(self, t)
        type(DImpurityReplace), intent(out) :: self
        type(DImpurity), intent(inout), target :: t
    ...
    subroutine p_propose_replace_impurity(self, op, outer_sst)
        type(DImpurityReplace), intent(inout) :: self
        type(TLocalOper), intent(in) :: op(:)
    ...
    function p_repl_get_operators(self) result(ops)
        type(DImpurityReplace), intent(in) :: self
        type(TLocalOper), allocatable :: ops(:)
        integer :: i
    ...
    function p_repl_allowed_outer_states(self) result(r)
        class(DImpurityReplace), intent(inout), target :: self
        integer, pointer :: r(:)
    ...
    logical function p_repl_is_allowed_outer(self, sst) result(is_allowed)
        class(DImpurityReplace), intent(inout) :: self
        integer, intent(in) :: sst
    ...
    subroutine fill_after(imp, pos, ket_work)
        type(DImpurity), intent(in) :: imp
        type(impurity_pos), intent(inout) :: pos(:)
        type(DTKet), intent(inout) :: ket_work
    ...
    subroutine fill_before(imp, pos, bra_work)
        type(DImpurity), intent(in) :: imp
        type(impurity_pos), intent(inout) :: pos(:)
        type(DTBra), intent(inout) :: bra_work
    ...
    subroutine p_init_grow_impurity(self, t)
        type(DImpurityGrow), intent(out) :: self
        type(DImpurity), intent(inout), target :: t
    ...
    subroutine p_propose_grow_impurity(self, ops, outer_sst)
        type(DImpurityGrow), intent(inout) :: self
        type(TLocalOper), intent(in) :: ops(:)
        integer, intent(in), optional :: outer_sst
    ...
    function grow_outer_state_for_outer_proposal(move) result(outerbl)
        type(DImpurityGrow), intent(in) :: move
    ...
    function grow_get_operators(self) result(ops)
        type(DImpurityGrow), intent(in) :: self
        type(TLocalOper), allocatable :: ops(:)
    ...
    subroutine grow_accept(self)
        class(DImpurityGrow), intent(inout) :: self
        integer :: inew, iold
    ...
    subroutine p_init_shrink_impurity(self, t)
        type(DImpurityShrink), intent(out) :: self
        type(DImpurity), intent(inout), target :: t
    ...
    subroutine p_propose_shrink_impurity(self, idx, outer_sst)
        type(DImpurityShrink), intent(inout) :: self
    ...
    function shrink_outer_state_for_outer_proposal(move) result(outerbl)
        type(DImpurityShrink), intent(in) :: move
        integer :: outerbl, fixedsst, chnewpos
        real(c_double) :: chtau
        type(TLocalOper), allocatable :: old_ops(:), new_ops(:)
    ...
    function shrink_get_operators(self) result(ops)
        type(DImpurityShrink), intent(in) :: self
        type(TLocalOper), allocatable :: ops(:)
    ...
    subroutine shrink_accept(self)
        class(DImpurityShrink), intent(inout) :: self
    ...
    subroutine p_init_shift_impurity(self, t)
        type(DImpurityShift), intent(out) :: self
        type(DImpurity), intent(inout), target :: t
    ...
    subroutine p_propose_shift_impurity(self, delta_tau)
        type(DImpurityShift), intent(inout) :: self
    ...
    integer function p_get_num_wrapped_ops(self) result(n)
        type(DImpurityShift), intent(in) :: self
    ...
    subroutine p_init_update_impurity(self, t)
        type(DImpurityUpdate), intent(out) :: self
        type(DImpurity), intent(inout), target :: t
    ...
    subroutine p_propose_update_impurity(self, idx, ops, outer_sst)
        type(DImpurityUpdate), intent(inout) :: self
        integer, intent(in) :: idx(:)
        type(TLocalOper), intent(in) :: ops(:)
        integer, intent(in), optional :: outer_sst
    ...
    subroutine p_update_get_newidx_addorder(move, out)
        type(DImpurityUpdate), intent(in) :: move
        integer, allocatable, intent(out) :: out(:)
