...
contains
    ...
    ! ######## METHODS FOR ANY DAccumulator ########

    subroutine p_accumulator_init(this, typ, ncomp, nlevels)
        type(DAccumulator), intent(inout) :: this
    ...
    subroutine p_accumulator_buffer(this, buf)
        type(DAccumulator), intent(inout), target :: this
    ...
    function p_accumulator_num_comp(this) result(answer)
        type(DAccumulator), intent(in) :: this
    ...
    ! ######## METHODS FOR AUTOCORRELATION DAccumulator ########
