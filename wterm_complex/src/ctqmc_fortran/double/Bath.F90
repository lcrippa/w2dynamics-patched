...
module DMBath
    ...
    !! concrete update type by setting a pointer of type(DTBathMoveBase)
    !! and then use weight_ratio() and accept_update().
    type, abstract, public :: DTBathMoveBase
        private

        !> pointer to DBath, that saves properties of currently accepted
        !! bath-configuration
        type(DTBath), pointer :: parent => null()
    contains
        private
    ...
    abstract interface
        subroutine base_accept_update(move)
            import :: DTBathMoveBase
            class(DTBathMoveBase), intent(inout) :: move
        end
    end interface
    ...
    type, extends(DTBathMoveBase), public :: DTBathMove
        private
        integer :: newsize
    ...
    type, extends(DTBathMoveBase), public :: DTBathAddMove
        private
        ...
        real(c_double), allocatable :: q(:,:), r(:,:), s(:,:)
        type(DBlockGrow) :: inner
    contains
        private
    ...
    !! current bath configuration in MBath.
    !! Upon acceptance, it updates MBath.
    type, extends(DTBathMoveBase), public :: DTBathRemMove
        private
    ...
    !! current bath configuration in MBath.
    !! Upon acceptance, it updates MBath.
    type, extends(DTBathMoveBase), public :: DTBathReplaceMove
        private
        ...
        real(c_double), allocatable :: repl_rows(:,:), repl_cols(:,:)

        type(DBlockReplaceRows) :: inner_rows
        type(DBlockReplaceCols) :: inner_cols
    contains
        private
    ...
    !! Upon acceptance, it updates MBath.
    type, extends(DTBathMoveBase), public :: DTBathShiftMove
        private
 ...
 contains
    ...
    function p_getinv(this) result(inv)
        type(DTBath), intent(in) :: this
        real(c_double), allocatable :: inv(:, :)
    ...
    subroutine p_init_bath_move(this, parent)
        type(DTBathMove), allocatable :: this
        type(DTBath), intent(in), target   :: parent
    ...
    subroutine p_setsize_move(self, newsize)
        type(DTBathMove), intent(inout) :: self
    ...
    subroutine p_propose_bath_move(move, crea, annh)
        type(DTBathMove), intent(inout) :: move
        type(TBathOperator), intent(in) :: crea(:), annh(:)

        real(c_double) :: mat(size(annh), size(crea))
    ...
    function p_bath_absratio(move) result(ratio)
        type(DTBathMove) :: move
        real(c_double) :: ratio
        type(DExtRange) :: detrat
    ...
    subroutine p_bath_accept(move)
        class(DTBathMove), intent(inout) :: move
    ...
    subroutine p_init_bath_add_move(this, parent)
        type(DTBathAddMove), allocatable :: this
        type(DTBath), intent(in), target   :: parent
    ...
    subroutine p_setsize_add(self, newsize, newk)
        type(DTBathAddMove), intent(inout) :: self
    ...
    function p_bath_absratio_add(move) result(ratio)
        type(DTBathAddMove), intent(inout)   :: move
        type(DExtRange)                       :: detrat
        real(c_double) :: ratio
    ...
    subroutine p_bath_accept_add(move)
        class(DTBathAddMove), intent(inout)   :: move
    ...
    subroutine p_init_bath_rem_move(this, parent)
        type(DTBathRemMove), allocatable :: this
        type(DTBath), intent(in), target   :: parent
    ...
    subroutine p_setsize_rem(self, newsize, newk)
        type(DTBathRemMove), intent(inout) :: self
        integer, intent(in) :: newsize, newk
    ...
    subroutine p_propose_bath_rem_move(move, remidx)
        type(DTBathRemMove), intent(inout)     :: move
    ...
    subroutine p_bath_accept_rem(move)
        class(DTBathRemMove), intent(inout)    :: move
    ...
    subroutine p_init_bathreplacemove(self, parent)
        type(DTBathReplaceMove), allocatable :: self
        type(DTBath), intent(in), target   :: parent
    ...
    subroutine p_setsize_repl(self, newsize, newk)
        type(DTBathReplaceMove), intent(inout) :: self
        integer, intent(in) :: newsize, newk
    ...
    subroutine p_propose_bathreplacemove(move, origidx, origtype, newop)
        type(DTBathReplaceMove), intent(inout)   :: move
    ...
    subroutine p_bath_accept_replace(move)
        class(DTBathReplaceMove), intent(inout)    :: move
    ...
    subroutine p_init_bath_shift_move(this, parent)
        type(DTBathShiftMove), allocatable :: this
        type(DTBath), intent(in), target   :: parent
    ...
    subroutine p_setsize_shift(self, newsize)
        type(DTBathShiftMove), intent(inout) :: self
        integer, intent(in) :: newsize
        integer :: currsize
    ...
    subroutine p_propose_bath_shift_move(move, delta_tau)
        type(DTBathShiftMove), intent(inout)   :: move
        real(c_double), intent(in)               :: delta_tau

        integer :: i

        real(c_double) :: iscale(move%parent%noper/2)
        real(c_double) :: jscale(move%parent%noper/2)
    ...
    function p_bath_absratio_shift(move) result(ratio)
        type(DTBathShiftMove), intent(in)   :: move
        real(c_double) :: ratio
    ...
    subroutine p_bath_accept_shift(move)
        class(DTBathShiftMove), intent(inout)   :: move
        ...
        !call verify_bath(move%parent%DTBath, 5d-2)
