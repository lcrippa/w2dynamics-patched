...
module ZMBath
    ...
    ! Re-exports
    public :: ZHybridization

    type, public :: ZTBath
        private
        integer :: NOper = 0    !< Number of operators in the trace
        real(c_double) :: beta       !< Inverse temperature
        ...
        class(ZHybridization), allocatable :: hybr
    ...
    abstract interface
        subroutine base_accept_update(move)
            import :: ZTBathMoveBase
            class(ZTBathMoveBase), intent(inout) :: move
        end
    end interface
    ...
    type, extends(ZTBathMoveBase), public :: ZTBathMove
        private
        integer :: newsize
    ...
    type, extends(ZTBathMoveBase), public :: ZTBathAddMove
        private
        ...
        complex(c_double_complex), allocatable :: q(:,:), r(:,:), s(:,:)
        type(ZBlockGrow) :: inner
    contains
        private
    ...
    !! current bath configuration in MBath.
    !! Upon acceptance, it updates MBath.
    type, extends(ZTBathMoveBase), public :: ZTBathRemMove
        private
    ...
    !! current bath configuration in MBath.
    !! Upon acceptance, it updates MBath.
    type, extends(ZTBathMoveBase), public :: ZTBathReplaceMove
        private
        ...
        complex(c_double_complex), allocatable :: repl_rows(:,:), repl_cols(:,:)

        type(ZBlockReplaceRows) :: inner_rows
        type(ZBlockReplaceCols) :: inner_cols
    contains
        private
    ...
    !! Upon acceptance, it updates MBath.
    type, extends(ZTBathMoveBase), public :: ZTBathShiftMove
        private
 ...
 contains
    ...
    function p_getinv(this) result(inv)
        type(ZTBath), intent(in) :: this
        complex(c_double_complex), allocatable :: inv(:, :)
    ...
    subroutine p_clear_bath(self)
        type(ZTBath), intent(inout) :: self
        integer :: block_idx(0)
        complex(c_double_complex) :: mat(0, 0)
    ...
    subroutine p_init_bath_move(this, parent)
        type(ZTBathMove), allocatable :: this
        type(ZTBath), intent(in), target   :: parent
    ...
    subroutine p_setsize_move(self, newsize)
        type(ZTBathMove), intent(inout) :: self
    ...
    subroutine p_propose_bath_move(move, crea, annh)
        type(ZTBathMove), intent(inout) :: move
        type(TBathOperator), intent(in) :: crea(:), annh(:)

        complex(c_double_complex) :: mat(size(annh), size(crea))
    ...
    function p_bath_absratio(move) result(ratio)
        type(ZTBathMove) :: move
        real(c_double) :: ratio
        type(ZExtRange) :: detrat
    ...
    subroutine p_bath_accept(move)
        class(ZTBathMove), intent(inout) :: move
    ...
    subroutine p_init_bath_add_move(this, parent)
        type(ZTBathAddMove), allocatable :: this
        type(ZTBath), intent(in), target   :: parent
    ...
    subroutine p_setsize_add(self, newsize, newk)
        type(ZTBathAddMove), intent(inout) :: self
    ...
    function p_bath_absratio_add(move) result(ratio)
        type(ZTBathAddMove), intent(inout)   :: move
        type(ZExtRange)                       :: detrat
        real(c_double) :: ratio
    ...
    subroutine p_bath_accept_add(move)
        class(ZTBathAddMove), intent(inout)   :: move
    ...
    subroutine p_init_bath_rem_move(this, parent)
        type(ZTBathRemMove), allocatable :: this
        type(ZTBath), intent(in), target   :: parent
    ...
    subroutine p_setsize_rem(self, newsize, newk)
        type(ZTBathRemMove), intent(inout) :: self
        integer, intent(in) :: newsize, newk
    ...
    subroutine p_propose_bath_rem_move(move, remidx)
        type(ZTBathRemMove), intent(inout)     :: move
    ...
    subroutine p_bath_accept_rem(move)
        class(ZTBathRemMove), intent(inout)    :: move
    ...
    subroutine p_init_bathreplacemove(self, parent)
        type(ZTBathReplaceMove), allocatable :: self
        type(ZTBath), intent(in), target   :: parent
    ...
    subroutine p_setsize_repl(self, newsize, newk)
        type(ZTBathReplaceMove), intent(inout) :: self
        integer, intent(in) :: newsize, newk
    ...
    subroutine p_propose_bathreplacemove(move, origidx, origtype, newop)
        type(ZTBathReplaceMove), intent(inout)   :: move
    ...
    subroutine p_bath_accept_replace(move)
        class(ZTBathReplaceMove), intent(inout)    :: move
    ...
    subroutine p_init_bath_shift_move(this, parent)
        type(ZTBathShiftMove), allocatable :: this
        type(ZTBath), intent(in), target   :: parent
    ...
    subroutine p_setsize_shift(self, newsize)
        type(ZTBathShiftMove), intent(inout) :: self
        integer, intent(in) :: newsize
        integer :: currsize
    ...
    subroutine p_propose_bath_shift_move(move, delta_tau)
        type(ZTBathShiftMove), intent(inout)   :: move
        real(c_double), intent(in)               :: delta_tau

        integer :: i

        complex(c_double_complex) :: iscale(move%parent%noper/2)
        complex(c_double_complex) :: jscale(move%parent%noper/2)
    ...
    function p_bath_absratio_shift(move) result(ratio)
        type(ZTBathShiftMove), intent(in)   :: move
        real(c_double) :: ratio
    ...
    subroutine p_bath_accept_shift(move)
        class(ZTBathShiftMove), intent(inout)   :: move
        ...
        !call verify_bath(move%parent%ZTBath, 5d-2)
