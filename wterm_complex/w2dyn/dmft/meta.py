...
QUANTITIES = {
    ...
    "p3phtau-worm": dict(
        axes=["ineq", "taubin", "taubin"],
        desc="Three legged two-particle Green's function ph in imaginary time"
        ),
    "p3pptau-worm": dict(
        axes=["ineq", "taubin", "taubin"],
        desc="Three legged two-particle Green's function pp in imaginary time"
        ),
    "g4iw-worm": dict(
        axes=["ineq", "iwf-g4", "iwf-g4", "iwb-g4"],
        desc=dedent("""\
        Two-particle Green's function in particle-hole Matsubara frequencies from worm sampling
        FIXME: There are two conventions:
        0: (v+w) tau_1 - v tau_2 + v' tau_3 - (v'+w) tau_4
        1: v tau_1 - (v-w) tau_2 + (v'-w) tau_3 - v' tau_4""")
        ),
    "g4tau-worm": dict(
        axes=["ineq", "tau-g4", "tau-g4", "tau-g4"],
        desc=dedent("""\
        Two-particle Green's function on imaginary time differences tau12, tau34, tau14.
        FIXME: conventions""")
        ),
    "g4iwpp-worm": dict(
        axes=["ineq", "iwf-g4", "iwf-g4", "iwb-g4"],
        ...
        FIXME: Convention: v tau_1 - (w-v') tau_2 + (w-v) tau_3 - v' tau_4""")
        ),
    "h4iw-worm": dict(
