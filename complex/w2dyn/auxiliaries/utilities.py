...
def recomplexify(arr):
    """Takes a real array-like arr and returns it as a complex array with
    real/imag. part taken from last axis.
    """
    if arr.shape[-1] != 2:
        raise ValueError("recomplexify: last axis must have length 2")
