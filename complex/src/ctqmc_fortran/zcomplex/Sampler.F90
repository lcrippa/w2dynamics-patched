...
module MSamplerZ
    ...
    type, public :: ZSamplePoint
        integer(c_int64_t) :: i
        real(c_double) :: x
        complex(c_double_complex) :: fx
    end type

    !> A buffer for the use of sampling points
    type, public :: ZSampleBuffer
        type(ZSamplePoint), allocatable :: buffer(:)
        integer :: n
    end type

    !> A sampling point, i.e., a tuple (i, x, f(x))
    type, public :: ZSamplePoint2D
        integer(c_int64_t) :: i
        real(c_double) :: x(2)
        complex(c_double_complex) :: fx
    end type ZSamplePoint2D

    !> A buffer for the use of sampling points
    type, public :: ZSampleBuffer2D
        type(ZSamplePoint2D), allocatable :: buffer(:)
        integer :: n
    end type ZSampleBuffer2D

    !> A sampling point, i.e., a tuple (i, x, f(x))
    type, public :: ZSamplePoint3D
        integer(c_int64_t) :: i
        real(c_double) :: x(3)
        complex(c_double_complex) :: fx
    end type ZSamplePoint3D

    !> A buffer for the use of sampling points
    type, public :: ZSampleBuffer3D
        type(ZSamplePoint3D), allocatable :: buffer(:)
        integer :: n
    end type ZSampleBuffer3D
    ...
    type, private, extends(ZSampler) :: binning_sampler
        integer :: nbins
    contains
    ...
    ! Sampler which just bins the data.
    type, private, extends(ZSampler2D) :: binning_sampler2d
        integer :: nbins(2)
    contains
    ...
    ! Sampler which just bins the data.
    type, private, extends(ZSampler3D) :: binning_sampler3d
        integer :: nbins(3)
    contains
    ...
    type, private, extends(ZSampler) :: matsubara_sampler
    ...
    type, private, extends(ZSampler2D) :: matsubara_sampler_2d
    ...
    type, private, extends(ZSampler) :: legendre_sampler
        integer :: nleg
    contains
    ...
    type, extends(ZSampler) :: nfft_sampler
        ! result frequencies
        integer, allocatable :: w(:)
    ...
    type, extends(ZSampler2D) :: nfft_sampler2d
        integer, allocatable :: w1(:), w2(:)
        integer :: nextgrid(2)
    ...
    type, extends(ZSampler3D) :: nfft_sampler3d
...
contains
    ...
    pure subroutine p_prepare_buffer(this, n)
        type(ZSampleBuffer), intent(inout) :: this
        integer, intent(in) :: n
    ...
    pure subroutine p_prepare_buffer2d(this, n)
        type(ZSampleBuffer2D), intent(inout) :: this
        integer, intent(in) :: n
    ...
    pure subroutine p_prepare_buffer3d(this, n)
        type(ZSampleBuffer3D), intent(inout) :: this
        integer, intent(in) :: n
    ...
    pure function sample_wraptau(this, sample) result(res)
        class(ZSampler), intent(in) :: this
        type(ZSamplePoint), intent(in) :: sample
        type(ZSamplePoint) :: res
    ...
    pure function sample_2d_wraptau(this, sample) result(res)
        class(ZSampler2D), intent(in) :: this
        type(ZSamplePoint2D), intent(in) :: sample
        type(ZSamplePoint2D) :: res
        integer :: i
    ...
    pure function sample_3d_wraptau(this, sample) result(res)
        class(ZSampler3D), intent(in) :: this
        type(ZSamplePoint3D), intent(in) :: sample
        type(ZSamplePoint3D) :: res
        integer :: i
    ...
    subroutine p_sampler_add_d(this, sample, acc)
        class(ZSampler), intent(inout) :: this
        type(ZSamplePoint), intent(in) :: sample(:)
        real(c_double), intent(inout) :: acc(this%nacc, this%ncomp)
        type(ZSamplePoint) :: convention_sample(size(sample))
    ...
    subroutine p_sampler_delete(this)
        class(ZSampler), allocatable, intent(inout) :: this
    ...
    subroutine p_sampler2d_add_d(this, sample, acc)
        class(ZSampler2D), intent(inout) :: this
        type(ZSamplePoint2D), intent(in) :: sample(:)
        real(c_double), intent(inout), target :: acc(this%nacc, this%ncomp)
        type(ZSamplePoint2D) :: convention_sample(size(sample))
        integer :: i
    ...
    subroutine p_sampler2d_delete(this)
        class(ZSampler2D), allocatable, intent(inout) :: this
    ...
    subroutine p_sampler3d_add_d(this, sample, acc)
        class(ZSampler3D), intent(inout) :: this
        type(ZSamplePoint3D), intent(in) :: sample(:)
        real(c_double), intent(inout), target :: acc(this%nacc, this%ncomp)
        type(ZSamplePoint3D) :: convention_sample(size(sample))
        integer :: i
    ...
    subroutine p_sampler3d_delete(this)
        class(ZSampler3D), allocatable, intent(inout) :: this
    ...
    subroutine rhist_init(this_s, ncomp, beta, statsign, nbins, coeff)
        class(ZSampler), allocatable, intent(inout) :: this_s
    ...
    subroutine rhist_add(this, sample, acc)
        ...
        type(ZSamplePoint), intent(in) :: sample(:)
        complex(c_double_complex), intent(inout) :: acc(0:this%nacc-1, this%ncomp)

        real(c_double) :: invd
        integer(c_int64_t) :: i, bin
        type(ZSamplePoint) :: curr
    ...
    subroutine rhist2d_init(this_s, ncomp, beta, statsign, nbins, coeffs)
        class(ZSampler2D), allocatable, intent(inout) :: this_s
    ...
    subroutine rhist2d_add(this, sample, acc)
        ...
        type(ZSamplePoint2D), intent(in) :: sample(:)
        complex(c_double_complex), intent(inout), target :: acc(0:this%nacc-1, this%ncomp)
        complex(c_double_complex), pointer :: buf(:, :, :)

        real(c_double) :: invd(2)
        integer(c_int64_t) :: i, bin(2)
        type(ZSamplePoint2D) :: curr
    ...
    subroutine rhist3d_init(this_s, ncomp, beta, statsign, nbins, coeffs)
        class(ZSampler3D), allocatable, intent(inout) :: this_s
    ...
    subroutine legendre_add(this, sample, acc)
        ...
        complex(c_double_complex) :: p0, p1, pnext, scaledx
        integer(c_int64_t) :: i, n
        type(ZSamplePoint) :: curr
    ...
    subroutine legendre_postprocess(this, acc, res)
        class(legendre_sampler), intent(inout) :: this
        complex(c_double_complex), intent(in), target :: acc(0:this%nacc-1, this%ncomp)
        complex(c_double_complex), intent(out), target :: res(0:this%npost-1, this%ncomp)
    ...
    subroutine gauss_add_slow(this, acc, pos, delta, fx)
        ...
        complex(c_double_complex), intent(in) :: fx
