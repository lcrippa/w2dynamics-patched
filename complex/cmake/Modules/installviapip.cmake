...
execute_process(COMMAND ${Python3_EXECUTABLE} -m pip freeze OUTPUT_VARIABLE PYTHON_PACKAGE_LIST)
    if ("${PYTHON_PACKAGE_LIST}" STREQUAL "")
        ...
        if ("${PYTHON_PACKAGE_LIST}" STREQUAL "")
            ...
            execute_process(COMMAND ${Python3_EXECUTABLE} ./get-pip.py --user RESULT_VARIABLE RES)
#            message(${RES})
...
execute_process(COMMAND ${Python3_EXECUTABLE} -m pip "install" "--user" ${module} RESULT_VARIABLE SUCCESS)
